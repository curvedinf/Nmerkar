...
| | Enmerkar | C++ | Rust | Python | Node.js |
|---|---|---|---|---|---|
| logextract 510 MB | 0.88 | **0.40** | 0.67 | 3.71 | 2.94 |
| analytics 512 MB | 1.38 | **0.99** | 1.71 | 4.47 | 3.39 |
...
| bfs n=1M | 0.59 | 0.11 | **0.09** | 1.68 | 0.25 |
| **total (6 CPU benches)** | 3.59 | **2.61** | 3.57 | 145.8 | 8.17 |
