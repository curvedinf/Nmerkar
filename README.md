...
| mandelbrot | 193 | 189 | 216 | **163** | 165 |
...
| **total** | **2563** | 3906 | 4003 | 2585 | 3096 |
...
| | Enmerkar | C++ | Rust | Python | Node.js |
|---|---|---|---|---|---|
| logextract 510 MB | 0.80 | **0.40** | 0.67 | 3.71 | 2.94 |
| analytics 512 MB | 1.23 | **0.99** | 1.71 | 4.47 | 3.39 |
...
| nqueens N=11 | 0.04 | **0.01** | 0.01 | 1.52 | 0.03 |
| bfs n=1M | 0.57 | 0.11 | **0.09** | 1.68 | 0.25 |
| **total (6 CPU benches)** | 3.36 | **2.61** | 3.57 | 145.8 | 8.17 |
